let app = new Vue({
    ...
    data: {
        ...
        totalGames: localStorage.getItem('sc2TotalGame') ? localStorage.getItem("sc2TotalGames") : 0,
        questions: questions,
        results: results,
        resultRace: 'infested',
    },
    methods: {
        ...
        endGame() {
            ...
            // protoss
            else if (this.score.protoss > this.score.zerg && this.score.protoss > this.score.terran && this.score.taldarim < 8 && Math.abs(this.score.protoss - this.score.zerg) > 3) {
                this.goToResult('protoss')
                this.totalGame.protoss++
            }
            // taldarim
            else if (this.score.protoss > this.score.zerg && this.score.terran > this.score.protoss && this.score.taldarim == 5) {
